package U6_Heaps_Questions.Kth_Smallest_Element;
...
//        Your task is to find the kth smallest element in the array nums. In other words,
//        if the elements of the array were sorted in ascending order, the element at the kth position (1-indexed) is the output.
...
//        This is the position of the element to return if the array was sorted in ascending order.
//        Output:
//        The function must return the kth smallest element in nums.
//        Constraints:
//        You must use a MaxHeap to solve this problem. A Heap class is already provided for you,
//        and you can use its methods to add elements to the heap (insert), remove the maximum element (remove),
